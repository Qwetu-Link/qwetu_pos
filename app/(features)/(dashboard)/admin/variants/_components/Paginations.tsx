...
export default function Pagination({
  ...
  const btnBase =
    "px-2.5 py-1.5 rounded-lg text-sm font-medium transition-colors disabled:opacity-40 disabled:cursor-not-allowed";
  const activeCls = "bg-emerald-600 text-white";
  const inactiveCls = "bg-slate-100 hover:bg-slate-200 text-slate-700";
