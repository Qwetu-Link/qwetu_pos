...
export const categoryData: CategoryMetric[] = [
  { name: "Men's Clothing", value: 1420000, color: "#2563eb" },
  { name: "Women's Clothing", value: 980000, color: "#7c3aed" },
  { name: "Accessories", value: 520000, color: "#db2777" },
  { name: "Footwear", value: 740000, color: "#d97706" },
  { name: "Kids Wear", value: 430000, color: "#059669" },
];
...
export const collectionData: CollectionMetric[] = [
...
export const businessProfile: BusinessProfile = {
  ...
  description:
    "Retail POS and Lipa Mdogo operations for apparel, footwear, accessories, and customer installment plans.",
};
